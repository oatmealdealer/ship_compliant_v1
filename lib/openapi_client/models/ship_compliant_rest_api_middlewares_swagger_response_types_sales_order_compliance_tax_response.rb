...
module OpenapiClient
  class ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesSalesOrderComplianceTaxResponse
    attr_accessor :sales_tax_rates
    ...
    def self.openapi_types
      {
        :'sales_tax_rates' => :'ShipCompliantRestAPIDomainsSalesOrderEntitiesSalesTaxRates',
        :'compliance_status' => :'String',
        :'key' => :'String',
        :'shipments' => :'Array<ShipCompliantRestAPIDomainsSalesOrderResponsesShipmentComplianceResponse>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesSalesOrderComplianceTaxResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesSalesOrderComplianceTaxResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'sales_tax_rates')
        self.sales_tax_rates = attributes[:'sales_tax_rates']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          sales_tax_rates == o.sales_tax_rates &&
    ...
    def hash
      [sales_tax_rates, compliance_status, key, shipments].hash
    end
