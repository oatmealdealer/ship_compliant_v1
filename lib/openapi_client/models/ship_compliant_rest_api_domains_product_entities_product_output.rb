...
module OpenapiClient
  class ShipCompliantRestAPIDomainsProductEntitiesProductOutput
    attr_accessor :age
    ...
    attr_accessor :marketplace_skus
    ...
    attr_accessor :brand_description
    ...
    def self.openapi_types
      {
        ...
        :'flavor' => :'String',
        :'gtin' => :'String',
        :'label' => :'ShipCompliantRestAPIDomainsProductEntitiesLabelOutput',
        :'marketplace_skus' => :'Array<String>',
        :'nabca' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ShipCompliantRestAPIDomainsProductEntitiesProductOutput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ShipCompliantRestAPIDomainsProductEntitiesProductOutput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'marketplace_skus')
        if (value = attributes[:'marketplace_skus']).is_a?(Array)
          self.marketplace_skus = value
        end
      end
      ...
      if attributes.key?(:'brand_description')
        self.brand_description = attributes[:'brand_description']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gtin == o.gtin &&
          label == o.label &&
          marketplace_skus == o.marketplace_skus &&
          nabca == o.nabca &&
          ...
          brand_description == o.brand_description
    end
    ...
    def hash
      [age, brand_key, default_case, default_retail_unit_price, default_wholesale_case_price, description, flavor, gtin, label, marketplace_skus, nabca, percent_alcohol, product_distribution, product_key, product_type, scc, unimerc, unit_price, upc, varietal, vintage, volume_amount, volume_unit, container_type, containers_per_selling_unit, brand_name, brand_description].hash
    end
