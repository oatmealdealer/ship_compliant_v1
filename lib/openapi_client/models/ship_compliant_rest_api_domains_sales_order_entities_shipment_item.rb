...
module OpenapiClient
  class ShipCompliantRestAPIDomainsSalesOrderEntitiesShipmentItem
    ...
    attr_accessor :product_unit_price
    ...
    def self.openapi_types
      {
        :'brand_key' => :'String',
        :'discounts' => :'Array<ShipCompliantRestAPIDomainsSalesOrderEntitiesShipmentItemDiscount>',
        :'product_key' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ShipCompliantRestAPIDomainsSalesOrderEntitiesShipmentItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ShipCompliantRestAPIDomainsSalesOrderEntitiesShipmentItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'product_unit_price')
        self.product_unit_price = attributes[:'product_unit_price']
      end

      if attributes.key?(:'citb')
        self.citb = attributes[:'citb']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          product_unit_price == o.product_unit_price &&
          citb == o.citb
    end
    ...
    def hash
      [brand_key, discounts, product_key, product_quantity, product_unit_price, citb].hash
    end
