...
# Unit tests for OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesProductNotFoundResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesProductNotFoundResponseError do
  let(:instance) { OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesProductNotFoundResponseError.new }

  describe 'test an instance of ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesProductNotFoundResponseError' do
    it 'should create an instance of ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesProductNotFoundResponseError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesProductNotFoundResponseError)
    end
  end
