...
# Unit tests for OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesBrandBadRequestResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesBrandBadRequestResponseError do
  let(:instance) { OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesBrandBadRequestResponseError.new }

  describe 'test an instance of ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesBrandBadRequestResponseError' do
    it 'should create an instance of ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesBrandBadRequestResponseError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ShipCompliantRestAPIMiddlewaresSwaggerResponseTypesBrandBadRequestResponseError)
    end
  end
